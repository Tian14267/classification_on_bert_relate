...
class Bert_pred(object):
	def __init__(self,pb_path):
		self.tokenizer = tokenization.FullTokenizer(vocab_file="./pretrain_models/chinese_L-12_H-768_A-12/vocab.txt", do_lower_case=True)
...
if __name__=="__main__":
	bertpred = Bert_pred(pb_path="./pb_models/classification_model.pb")
	#while 1:
