    ...
    try:
        ...
        with graph.as_default():
            with tf.Session() as sess:
                ...
                #bert_config = modeling.BertConfig.from_json_file(os.path.join(args.bert_model_config, 'bert_config.json'))
                bert_config = modeling.BertConfig.from_json_file(args.bert_model_config)
...
if __name__ == '__main__':
    ...
    """
    bert_model_config="/mnt/sda1/transdat/bert-demo/bert/chinese_L-12_H-768_A-12"
    ...
    parser.add_argument('-bert_model_config', type=str, required=True,
