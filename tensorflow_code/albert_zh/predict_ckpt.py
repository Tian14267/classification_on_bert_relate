...
class AlBert_pred_ckpt(object):
	def __init__(self):
		...
		self.tokenizer = tokenization.FullTokenizer(vocab_file="./pre_trained_model/albert_tiny_489k/vocab.txt",
													do_lower_case=True)

		bert_config = modeling.BertConfig.from_json_file("./pre_trained_model/albert_tiny_489k/albert_config_tiny.json")
		num_labels = 97
		...
		model_path = 'outputs/selfdata_albert_tiny_489k_output_epoch15/model.ckpt-7728'
