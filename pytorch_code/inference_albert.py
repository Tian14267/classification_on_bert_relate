...
import numpy as np
import argparse
from models.albert_models import AlbertModel, BertTokenizer
from utils import *
...
class Model(nn.Module):
    def __init__(self, config):
        ...
        self.bert = AlbertModel.from_pretrained(config.bert_path)  ### 加载相关信息，如vocab和config等
...
class ModelInit(object):
    def __init__(self):
        ...
        parser.add_argument('--model_name', type=str, default="albert", help='')
        #parser.add_argument('--bert_path', type=str, default="./pretrain_model/albert_chinese_base", help='')
        parser.add_argument('--bert_path', type=str, default="./saved_models/sql_128/THUCNews/albert_base_train", help='')
