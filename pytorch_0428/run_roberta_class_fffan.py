...
def main():
    ...
    parser.add_argument('--model_path', type=str, default="/data/fffan/01_experiment/08_Bert/00_models/chinese_roberta_wwm_large_ext_pytorch", help='')
    parser.add_argument('--bert_path', type=str,
                        default="/data/fffan/01_experiment/08_Bert/00_models/bert-base-chinese", help='')
    parser.add_argument('--train_path', type=str,
                        default="/data/fffan/01_experiment/08_Bert/02_classify/data/messanswer_data_train/messanswer_train.txt",
                        help='')
    ...
    parser.add_argument('--save_path', type=str, default="./saved_models/sql_256/", help='')
